 ...
 * @internal
 */
#[CoversClass(GetServerRandomNumber::class)]
final class GetServerRandomNumberTest extends TestCase
{
    ...
    public function testExecuteWithMinAndMax(): void
    {
    ...
    public function testExecuteWithOnlyMax(): void
    {
        $parameters = ['max' => 100];
    ...
    public function testExecuteWithNoParameters(): void
    {
        $parameters = [];
    ...
    public function testExecuteWithNegativeRange(): void
    {
    ...
    public function testExecuteWithSameMinMax(): void
    {
    ...
    public function testExecuteWithLargeRange(): void
    {
    ...
    public function testMultipleExecutionsProduceDifferentResults(): void
    {
    ...
    public function testExecuteWithZeroMax(): void
    {
